    ...
    override func viewDidLoad() {
        ...
        if let configDict = UserDefaults.standard.dictionary(forKey: "com.apple.configuration.managed"),
            ...
            if let _ = configDict["eaShow"], let _ = configDict["eaID"] {
                eaShow = configDict["eaShow"] as! String
            ...
            username   = "userAssign"
            password   = "S3cr3t"
            deviceUdid = "80023a617b92bbcb3b3b3b33a3df5ac0b188a654"   // test device udid
            eaShow     = "yes"
            eaID       = "19"
        }   // if let configDict - end
        
        // pull list for dropdown from EA - make sure account can read Mobile Device Extension Attributes
...
//                            print("popup_choices for \(self.eaName): \(self.popup_choices)")
                        ...
                        DispatchQueue.main.async {
                            if self.eaShow.lowercased() == "yes" {
                                self.config_Button.isHidden = false
                                self.selectedConfig_TextField.isHidden = false
                            }
                        }
                    }
                }
